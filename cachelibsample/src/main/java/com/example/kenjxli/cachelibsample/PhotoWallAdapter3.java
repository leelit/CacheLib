...
/**
 * Created by kenjxli on 2015/7/15.
 */
public class PhotoWallAdapter3 extends ArrayAdapter<String> implements AbsListView.OnScrollListener {
    ...
    public PhotoWallAdapter3(Context context, int resource, String[] objects, GridView PhotoWall) {
        super(context, resource, objects);
        mPhotoWall = PhotoWall;
        memoryCacheUtil = MemoryCacheUtil.getInstance();
        diskCacheUtil = DiskCacheUtil.getInstance(context, "bitmap");
        tasks = new HashSet<>();
    ...
    private void setImageView(String imageUrl, ImageView imageView) {
        ...
        if (bitmap != null) {
            ...
            // ¥≈≈Ãª∫¥Ê
            bitmap = diskCacheUtil.getBitmapFromDiskCache(imageUrl);
            if (bitmap != null) {
    ...
    private class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
        ...
        private Bitmap downloadBitmap() {
            ...
            try {
                ...
                // œ»∑≈»Î”≤≈Ãª∫¥Ê
                boolean result = diskCacheUtil.addBitmapToDiskCache(imageUrl, inputStream);
                // ¥””≤≈Ãª∫¥Ê»°≥ˆ
                bitmap = diskCacheUtil.getBitmapFromDiskCache(imageUrl);
                if (bitmap != null) {
                    // ∑≈»Îƒ⁄¥Êª∫¥Ê
